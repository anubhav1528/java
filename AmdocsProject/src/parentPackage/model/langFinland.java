...
public class langFinland {
	...
	public langFinland(int original_id, String message_code, int bA, int cycle, String message_is_valid,
			String message_text) {
		super();
	...
	public String toString() {
		return "langFinland [original_id=" + original_id + ", Message_code=" + Message_code + ", BA=" + BA + ", cycle="
