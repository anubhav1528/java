...
public class langEnglish {
	...
	public langEnglish(int original_id, String message_code, int bA, int cycle, String message_is_valid,
			String message_text) {
		super();
	...
	public String toString() {
		return "langEnglish [original_id=" + original_id + ", Message_code=" + Message_code + ", BA=" + BA + ", cycle="
