...
<body>
<%-- 	<jsp:useBean id="e" class="/JSPTagLibrary/src/Model/Employee.java" scope="request"> --%>

		<form id="form-1" action="controller.do" method="post">
			<label for="input-1">Name-</label>
			<br>
			<input id="input-1" name="name"type="text" /> <br /> 
			<label for="input-2">Address-</label> 
			<br>
			<input id="input-2" name="address" type="text" /> <br /> 
